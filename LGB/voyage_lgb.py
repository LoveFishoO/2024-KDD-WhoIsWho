...
with open('../out_data/voyage_title_data.pkl', 'rb') as f:
    TITLE_EMBEDDINGS = pl.load(f)

with open('../out_data/voyage_abstract_data.pkl', 'rb') as f:
    ABSTRACT_EMBEDDINGS = pl.load(f)

with open('../out_data/voyage_venue_data.pkl', 'rb') as f:
...
def main(train_author,valid_author, pid_to_info, submission, task):
    ...
    res_path = f'../output/voyage_lgb.json'
    ...
    out_train.to_csv('../out_data/voyage_train.csv', index=False)
    out_test.to_csv('../out_data/voyage_test.csv', index=False)
    return res_path
...
if __name__ == '__main__':
    ...
    rp = main(train_author,valid_author, pid_to_info, submission, 'voyage_pred')
