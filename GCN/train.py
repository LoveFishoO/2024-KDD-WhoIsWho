...
def add_arguments(args):
    ...
    args.add_argument('--saved_dir', type=str, help="save_dir", default= "./graph_model")
...
if __name__ == "__main__":
    ...
    encoder = GCNModel(args.input_dim,args.output_dim).to(device)
    ...
    for epoch_num in range(args.epochs):
        ...
        for tmp_train in tqdm(train_data):
            ...
            if args.threshold > 0:
                ...
                adj_weight[:,1:] = torch.where(flag,torch.tensor(0.0).to(device),adj_weight[:,1:])
